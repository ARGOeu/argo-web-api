...
var statusV5Routes = []respond.AppRoutes{
	...
	{Name: "status.list", Verb: "GET", Path: "/{report-name}/endpoints", SubrouterHandler: GetEndpointStatus},
	{Name: "status.get", Verb: "GET", Path: "/{report-name}/endpoints/{endpoint-name}", SubrouterHandler: GetEndpointStatus},
	...
	{Name: "status.options", Verb: "OPTIONS", Path: "/{report-name}/endpoints", SubrouterHandler: Options},
	{Name: "status.options", Verb: "OPTIONS", Path: "/{report-name}/endpoints/{endpoint-name}", SubrouterHandler: Options},
