		...
		"db_conf": []bson.M{
			{
				...
				"server":   "localhost",
				"port":     27017,
				"database": "argotest_status_services_ta",
				"username": "",
				"password": ""},
		},
		"users": []bson.M{
		...
		"db_conf": []bson.M{
			{
				...
				"server":   "localhost",
				"port":     27017,
				"database": "argotest_status_services_tb",
				"username": "",
				"password": ""},
		},
		"users": []bson.M{
...
func (suite *StatusServicesTestSuite) TestThresholds() {
	...
	fullurl1 := "/api/v5/status/Report_A/groups/GROUP-03" +
		"/service-types/CREAM-CE" +
		"?start-time=2015-05-02T00:00:00Z&end-time=2015-05-02T23:00:00Z&view=details"
...
func (suite *StatusServicesTestSuite) TestOptionsStatusServices() {
	request, _ := http.NewRequest("OPTIONS", "/api/v5/status/Report_A/groups/GROUP_A/service-types", strings.NewReader(""))
	...
	request, _ = http.NewRequest("OPTIONS", "/api/v5/status/Report_A/groups/GROUP_A/service-types/service_a", strings.NewReader(""))
...
func (suite *StatusServicesTestSuite) TearDownTest() {
	...
	suite.cfg.MongoClient.Database("argotest_status_services").Drop(context.TODO())
	suite.cfg.MongoClient.Database("argotest_status_services_ta").Drop(context.TODO())
	suite.cfg.MongoClient.Database("argotest_status_services_tb").Drop(context.TODO())
