		...
		"db_conf": []bson.M{
			{
				...
				"server":   "localhost",
				"port":     27017,
				"database": "argotest_status_groups_taa",
				"username": "",
				"password": ""},
		},
		"users": []bson.M{
		...
		"db_conf": []bson.M{
			{
				...
				"server":   "localhost",
				"port":     27017,
				"database": "argotest_status_groups_tbb",
				"username": "",
				"password": ""},
		},
		"users": []bson.M{
...
func (suite *StatusEndpointGroupsTestSuite) TestListStatusEndpointGroups() {
 ...
 "status": {
  ...
  "details": "You need to provide a correct authentication token using the header 'x-api-key'"
	...
	fullurl3 := "/api/v5/status/Report_B/groups" +
		"?start-time=2015-05-01T00:00:00Z&end-time=2015-05-01T23:00:00Z"
...
func (suite *StatusEndpointGroupsTestSuite) TestMultipleItems() {
	...
	fullurl1 := "/api/v5/status/Report_A/groups" +
		"?start-time=2015-05-01T00:00:00Z&end-time=2015-05-01T23:00:00Z"
...
func (suite *StatusEndpointGroupsTestSuite) TestOptionsStatusEndpointGroups() {
	request, _ := http.NewRequest("OPTIONS", "/api/v5/status/Report_A/groups", strings.NewReader(""))
	...
	request, _ = http.NewRequest("OPTIONS", "/api/v5/status/Report_A/groups/GROUP_A", strings.NewReader(""))
...
func (suite *StatusEndpointGroupsTestSuite) TearDownTest() {
	...
	suite.cfg.MongoClient.Database("argotest_status_groups_v5").Drop(context.TODO())
	suite.cfg.MongoClient.Database("argotest_status_groups_taa").Drop(context.TODO())
	suite.cfg.MongoClient.Database("argotest_status_groups_tbb").Drop(context.TODO())
}
