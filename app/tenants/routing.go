...
var appRoutesV2 = []respond.AppRoutes{
	...
	{Name: "tenants.get_ready", Verb: "GET", Path: "/tenants/{ID}/ready", SubrouterHandler: ListReady},
	...
	{Name: "tenants.node_set", Verb: "POST", Path: "/tenants/{ID}/node-set", SubrouterHandler: NodeSet},
	{Name: "tenants.node_unset", Verb: "POST", Path: "/tenants/{ID}/node-unset", SubrouterHandler: NodeUnset},
	...
	{Name: "tenants.update_info", Verb: "PUT", Path: "/tenants/{ID}/info", SubrouterHandler: UpdateInfo},
	{Name: "tenants.update_db_conf", Verb: "PUT", Path: "/tenants/{ID}/db-conf", SubrouterHandler: UpdateDbConf},
	{Name: "tenants.update_topology", Verb: "PUT", Path: "/tenants/{ID}/topology", SubrouterHandler: UpdateTopology},
	...
	{Name: "tenants.options", Verb: "OPTIONS", Path: "/tenants/{ID}/info", SubrouterHandler: Options},
	{Name: "tenants.options", Verb: "OPTIONS", Path: "/tenants/{ID}/db-conf", SubrouterHandler: Options},
	{Name: "tenants.options", Verb: "OPTIONS", Path: "/tenants/{ID}/topology", SubrouterHandler: Options},
	{Name: "tenants.options", Verb: "OPTIONS", Path: "/tenants/{ID}/ready", SubrouterHandler: Options},
