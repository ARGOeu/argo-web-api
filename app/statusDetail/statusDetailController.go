...
func List(r *http.Request, cfg config.Config) (int, http.Header, []byte, error) {
	...
	reportResult := reports.MongoInterface{}
	...
	// Get Report details
	err = reportCol.Find(bson.M{"info.name": input.report}).One(&reportResult)
	if err != nil {
	...
	selectedGroupType = reports.DetermineGroupType(reportResult, input.groupType)
