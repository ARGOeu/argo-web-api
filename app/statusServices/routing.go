...
var appRoutesV2 = []respond.AppRoutes{
	{Name: "status.get", Verb: "GET", Path: "/{report_name}/{group_type}/{group_name}/services/{service_name}", SubrouterHandler: routeCheckGroup},
	{Name: "status.list", Verb: "GET", Path: "/{report_name}/{group_type}/{group_name}/services", SubrouterHandler: routeCheckGroup},
	{Name: "status.options", Verb: "OPTIONS", Path: "/{report_name}/{group_type}/{group_name}/services/{service_name}", SubrouterHandler: Options},
	{Name: "status.options", Verb: "OPTIONS", Path: "/{report_name}/{group_type}/{group_name}/services", SubrouterHandler: Options},
}
